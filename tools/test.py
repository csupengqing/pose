...
from lib.core.loss import JointsMSELoss, NMTCritierion, NMTNORMCritierion, KLDiscretLoss, JointsOHKMMSELoss
from lib.core.function import validate_heatmap, validate_simdr, validate_sa_simdr
...
def main():
    ...
    if cfg.LOSS.TYPE == 'JointsMSELoss':
        ...
        criterion = JointsOHKMMSELoss().cuda() 
