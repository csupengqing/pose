...
from core.loss import JointsMSELoss, NMTCritierion, NMTNORMCritierion, KLDiscretLoss, JointsOHKMMSELoss
...
def main():
    ...
    logger.info('#####################################')
    logger.info('Best Model performance:{}'.format(best_perf))
